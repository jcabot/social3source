...
brief. All entries are included using `\nocite{*}` and BibTeX's standard
`unsrt` style (numbered references in citation order). Bibliographic metadata
and source claims have not been independently verified.
